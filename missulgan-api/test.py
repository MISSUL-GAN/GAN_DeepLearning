...
It then runs inference for '--num_test' images_cnn and save results to an HTML file.
...
Example (You need to train models first or download pre-trained models from our website):
    ...
    This option will automatically set '--dataset_mode single', which only loads the images_cnn from one set.
...
if __name__ == '__main__':
    opt = TestOptions().parse("style_cezanne_pretrained")  # get test options
