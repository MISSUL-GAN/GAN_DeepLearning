...
class ColorizationModel(Pix2PixModel):
    """This is a subclass of Pix2PixModel for image colorization (black & white image -> colorful images_cnn).
    ...
    def __init__(self, opt):
        ...
        # specify the images_cnn to be visualized.
        self.visual_names = ['real_A', 'real_B_rgb', 'fake_B_rgb']

    def lab2rgb(self, L, AB):
        """Convert an Lab tensor image to a RGB numpy output
        Parameters:
            L  (1-channel tensor array): L channel images_cnn (range: [-1, 1], torch tensor array)
            AB (2-channel tensor array):  ab channel images_cnn (range: [-1, 1], torch tensor array)

        Returns:
            rgb (RGB numpy image): rgb output images_cnn  (range: [0, 255], numpy array)
        """
        AB2 = AB * 110.0
        L2 = (L + 1.0) * 50.0
    ...
    def compute_visuals(self):
        """Calculate additional output images_cnn for visdom and HTML visualization"""
