...
def main():
    ...
    content_image = imread("images/origin1.jpg")
    style_images = [imread("images/style1.jpg")]

    style_blend_weights = [1.0 / len(style_images) for _ in style_images]

    try:
        imsave("images/result8.jpg", np.zeros((500, 500, 3)))
    except:
        raise IOError(
    ...
    imsave("images/result8.jpg", image)
